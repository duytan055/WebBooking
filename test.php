    ...
    <div class="NowMovies">
        <header>
            <div>
                ...
                <p class="subtitle">Lướt qua các bộ phim đang hot trên rạp, xem thông tin nhanh và đặt vé ngay khi muốn.</p>
            </div>
            <a href="SoonMovies.php">Phim sắp chiếu</a>
        </header>

        <div class="movie-box">
            <ul class="movie-list">
                <?php while ($row = $result->fetch_assoc()) { ?>
                    <li class="movie-item" onclick="window.location.href='../Pages/SeeMoreMovies.php?id=<?= $row['id_phim'] ?>'">
                        <div class="box_img">
                        ...
                        <div class="box_hover">
                            ...
                            <div class="box_button">
                                <button
                                    ...
                                    data-trailer="<?= htmlspecialchars($row['trailer_phim']) ?>">
                                    <strong>▶ Trailer</strong></button>
                                <a href="../Pages/buyticket.php?id=<?= $row['id_phim'] ?>"><button type="button" onclick="event.stopPropagation(); return false;"><strong>🎟 Đặt vé</strong></button></a>
                            </div>
                            <div class="bottom">
...
<div class="page-shell">
    <div class="NowMovies">
        ...
        <div class="movie-box">
            <ul class="movie-list">
                <?php while ($row = $result->fetch_assoc()) { ?>
                    <li class="movie-item" <?= $row['id_phim'] ?>'">
                        <div class="box_img">
                            <img src="../poster/<?= htmlspecialchars($row['poster']) ?>" alt="<?= htmlspecialchars($row['ten_phim']) ?>">
                        </div>
